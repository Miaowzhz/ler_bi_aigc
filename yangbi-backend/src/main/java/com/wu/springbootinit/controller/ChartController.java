...
import com.wu.springbootinit.bizmq.BiMessageProducer;
import com.wu.springbootinit.manager.RedisLimiterManager;
...
import com.wu.springbootinit.manager.AiManager;
import com.wu.springbootinit.model.dto.chart.*;
import com.wu.springbootinit.model.vo.BiResponse;
...
//    }
    ...
    public BaseResponse<BiResponse> genChartByAi(@RequestPart("file") MultipartFile multipartFile,
        ...
        ThrowUtils.throwIf(size>ONE_MB, ErrorCode.PARAMS_ERROR,"文件大于 1M");
        //校验文件后缀
    ...
    public BaseResponse<BiResponse> genChartByAiAsync(@RequestPart("file") MultipartFile multipartFile,
        ...
        CompletableFuture.runAsync(() -> {
            // 修改图表任务状态 执行中->已完成->保存执行结果 ；执行失败后，状态改成 "失败"，记录任务失败信息
